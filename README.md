...
* Source Code
	...
	2. [Project1.py](https://github.com/dannofield/Self-driving-car/blob/master/Project1.ipynb) Generates video output and it plays the videos in real time
	3. [Utils.py](https://github.com/dannofield/Self-driving-car/blob/master/utils.py) Has the modified function to extrapolate lines on the road
